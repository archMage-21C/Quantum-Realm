...
- Idea logs and brainstorming notes.
...
- Use consistent naming: `ProjectName - YYYY-MM` or similar.
- Create a `README.md` inside each project folder to summarize:
  - Goal of the project.
  - Timeline & progress.
...
- Avoids clutter by separating archival material from active drafts.
- Makes it easier to revisit old ideas and reuse them in new work.
